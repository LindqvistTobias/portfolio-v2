...
const projectSpotify = {
  ...
  skills: ["React", "JavaScript", "Node.js", "Material UI", "Spotify API"],
  img: spotifyCloneImage,
  githubLink: "https://github.com/LindqvistTobias/spotifyclone",
  demoLink: "https://tl-spotify-clone.netlify.app"
}
...
const projectRestAPI = {
  ...
  skills: ["React", "JavaScript", "Node.js", "API"],
  img: flagAppImage,
  githubLink: "https://github.com/LindqvistTobias/flag-project",
  demoLink: "https://tl-flag-project.netlify.app/"
}
...
const projectPasswordGenerator = {
  ...
  githubLink: "https://github.com/LindqvistTobias/tl-passwordGenerator",
  demoLink: "https://tl-passwordgenerator.netlify.app/"
}
